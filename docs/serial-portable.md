...
- Windows x86-64: run `tio-gui-0.3.5-windows-x86_64-setup.exe`. Installation is per
  user, with Start menu/Desktop shortcuts and an entry in installed applications.
- macOS Apple Silicon: open `tio-gui-0.3.5-macos-arm64.dmg` and drag tio-gui to
